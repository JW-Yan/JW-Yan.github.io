...
#### **Functional genomics**
![]({{ site.url }}{{ site.baseurl }}/images/respic/Lab_research.png){: style="width: 55%; float: right; margin: 10px 10px"}
...
#### **Disease Progression.** 
![]({{ site.url }}{{ site.baseurl }}/images/respic/brain_progression.png){: style="width: 80%; float: right; margin: 10px 10px"}
